...
const Vote: React.FC<Props> = ({
  ...
  return (
    <div className="bg__default w-full flex flex-col items-center justify-center pt-32">
      <div className="text-center ">
        <p className="text-stroke text-[28px] md:text-[35px] text-[#EB3541] font-extrabold">
          หลังจากได้ชิมสินค้าตัวอย่างแล้ว
        </p>
        <p className="text-stroke text-[28px] mt-[-12px] md:text-[35px] text-[#EB3541] font-extrabold">
          คุณชอบมากน้อยแค่ไหน
        </p>
      </div>
      <div>
