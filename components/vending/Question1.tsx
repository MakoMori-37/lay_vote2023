...
const Question1: React.FC<Props> = ({ onNext = () => {} }) => {
  ...
  const handleSubmit = () => {
    ...
    // if (selectedValues.includes("7") && !reason) {
      ...
      <div>
        ...
        <div className={`flex items-center w-full mx-auto gap-4`}>
          ...
          {/* {selectedValues.includes("7") ? (
            <input className="input__other" onChange={handleChangeReason} />
          ) : (
            <label htmlFor="radio-7">
              <p className="text-stroke text-[25px] md:text-[28px] text-[#EB3541] font-extrabold">
                อื่นๆ
              </p>
            </label>
          )} */}
